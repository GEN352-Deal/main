  ...
  if (confirmed) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%', alignItems: 'center', justifyContent: 'center', gap: 16, padding: 24, textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 28, letterSpacing: 1 }}>SWAP CONFIRMED!</h2>
        ...
        <div className="exchange-body">
          ...
          {step === 0 && (
            <div className="exchange-section animate-fadeIn">
              <h3 className="exchange-section-title">How would you like to swap?</h3>
          ...
          {method === 'meetup' && step === 2 && (
            <div className="exchange-section animate-fadeIn">
              ...
              <div className="info-box">
                ...
                <span>Phone numbers will only be shared with your swap partner after confirmation.</span>
              </div>
            </div>
          )}
